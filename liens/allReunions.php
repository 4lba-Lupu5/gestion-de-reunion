            ...
            <tbody>
                 <?php
                    if($rootVue)
                    {
                        ...
                        where R.idTypeReunion=T.idTypeReunion and R.idPrioriteReunion=P.idPrioriteReunion and R.idEtatReunion=E.idEtatReunion and R.idModeReunion=M.idModeReunion and R.idCompte=C.idCompte
                    ...
                    else
                    {
                        ...
                        from Reunion R,TypeReunion T,PrioriteReunion P,EtatReunion E,ModeReunion M,Compte C
                        where R.idTypeReunion=T.idTypeReunion and R.idPrioriteReunion=P.idPrioriteReunion and R.idEtatReunion=E.idEtatReunion and R.idModeReunion=M.idModeReunion and R.idCompte=C.idCompte and C.idCompte=$compte
                        order by jourReunion desc";
                    }
...
//                        Gestion du nombre d'ordre
                        ...
                        for($i=1;$i<13;$i++)
                        {
                            if($i<10)
                            {
                                ...
                                {
                                 ?>
                                    <td><a class="charge" title="Voir le Proces Verbal etablit" href="#?id=<?= getWebId($line[0],"Reunion","crypted")?>&&etat=<?= $line[8] ?>"><i class="fa fa-cloud-download"></i></a></td>
                                  <?php
                                }
                            }
                            else
                            ...
                            ?>
                                <td><center>
<!--                                <a class="archive" title="Modifier les valeurs" href="index.php?page=#&&id=< ?= getWebId($line[0],"Reunion","crypted")?>&&src=Reunion"><i class='fa fa-archive fa-1x'></i></a>-->
