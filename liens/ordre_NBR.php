...
<!--  <form method="GET" class="modal-content animate" action="index.php?page=participantAjout&&">-->
  <form method="POST" class="modal-content animate" action="index.php?page=ordreAjout&&id=<?= getWebId($idReunion,"Reunion","crypted")?>">
    ...
    <div class="imgcontainer">
      ...
      <h2 style="text-align:center">Ordres</h2>
    </div>

    <div class="container">      
      <center><input type="number" name="nbrOrdre"></center>       
