<?php
    ...
    {
        $rootVue=true;
        echo "<center><caption><h2><u>Mes Reunions : $Reunion[0] </u></h2> <h4><u>Tous: $ReunionAll[0] </u></h4> <h6><u>Autres: $reste</u></h6></caption></center>";
    }
    else 
        echo "<center><caption><h4><u>Mes Reunions : $Reunion[0] </u></h4></caption></center>";
?>
<center>
    <a href="index.php?page=listeOptionReunion&&src=archive" class="btn btn-primary" style="width: 15%">Mes Archives</a>
    <a href="index.php?page=listeOptionReunion&&src=participant" class="btn btn-secondary" style="width: 15%">Mes Participants</a>
    <a href="index.php?page=listeOptionReunion&&src=ordre" class="btn btn-warning" style="width: 15%">Mes Ordres</a>
    <a href="index.php?page=listeOptionReunion&&src=reunion" class="btn btn-danger" style="width: 15%">Reunions</a><br><br>
...
//                        Gestion du nombre d'ordre
                        ...
                        for($i=1;$i<13;$i++)
                        {
                            ...
                            ?>
                                <td><center>
                                <a class="modifie" title="Modifier les valeurs" href="index.php?page=editReunion&&id=<?= getWebId($line[0],"Reunion","crypted")?>&&src=Reunion"><i class='fa fa-edit fa-1x'></i></a>
                                <a class="supprime" title="Supprimer la Reunion" href="php/deleteItem.php?id=<?= getWebId($line[0],"Reunion","crypted")?>&&src=Reunion&&page=home" onclick="return confirm('Confirmer la suppression la reunion <?php //$line[1].' '.$line[2]?>');"><i class='fa fa-trash-o fa-1x'></i></a>
                                <a class="archive" title="Archiver la Reunion" href="php/Archiver_Desarchiver.php?id=<?= getWebId($line[0],"Reunion","crypted")?>&&page=home&&src=Reunion"><i class="fa fa-archive"></i></a> 
                                </center></td> 
                           <?php 
                                }
                            }
            ...
            <tfoot>     
                <tr>
                    <td colspan=""><a href="index.php?page=#"><center><u>   </u></center></a></td>
                </tr>
            </tfoot>
</table>
</center> 